        ...
        <main className="max-w-7xl mx-auto px-4 py-8">
          ...
          <div className="mt-8 p-6 bg-white rounded-lg shadow-lg border-l-4 border-blue-500">
            ...
            <ol className="list-decimal list-inside space-y-2 text-sm text-gray-700">
              <li>
                <strong>Connect Wallet:</strong> Click "Connect with Privy" to create or connect a Solana wallet
              </li>
              <li>
                <strong>Request Airdrop:</strong> Get devnet SOL (1 SOL = test funds for devnet)
              </li>
              <li>
                <strong>Check Vault:</strong> Your vault address is automatically derived from your wallet
              </li>
              <li>
                <strong>Place Bet:</strong> Choose amount and heads/tails, then place your bet
              </li>
              <li>
                <strong>Monitor Results:</strong> Watch the transaction log for real-time status updates
              </li>
              <li>
                <strong>Verify On-Chain:</strong> Click transaction links to view on Solana Explorer
              </li>
            </ol>
            <div className="mt-4 pt-4 border-t border-gray-200">
              <p className="text-xs text-gray-500">
                <strong>Backend API:</strong> {import.meta.env.VITE_API_BASE_URL || 'http://localhost:3001'}
                <br />
                <strong>Program ID:</strong> {import.meta.env.VITE_VAULT_PROGRAM_ID}
                <br />
