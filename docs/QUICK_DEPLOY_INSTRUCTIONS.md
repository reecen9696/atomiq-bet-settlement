...
cat /Users/reece/code/projects/atomik-wallet/solana-playground-deploy/programs/vault/src/lib.rs
```
...
```bash
# Copy this file:
cat /Users/reece/code/projects/atomik-wallet/solana-playground-deploy/programs/vault/src/state.rs
```
...
```bash
# Copy this file:
cat /Users/reece/code/projects/atomik-wallet/solana-playground-deploy/programs/vault/src/errors.rs
```
...
# The system now always uses real Solana transactions
...
1. **Make code changes locally** in `solana-playground-deploy/programs/vault/src/`
