...
const PROGRAM_ID = new PublicKey('HTg6Cs11FNiRXjQ2wFiQodKrVuTQdEJYk8j4RtfX56rP');
...
async function main() {
  ...
  console.log('  Funder:', (funderBalance / LAMPORTS_PER_SOL).toFixed(4), 'SOL');
  console.log('  Vault Authority:', (vaultBalance / LAMPORTS_PER_SOL).toFixed(4), 'SOL\n');
  ...
  console.log('New Vault Authority Balance:', (newVaultBalance / LAMPORTS_PER_SOL).toFixed(4), 'SOL');
}
